console.log("Welcome To My Othello");
let turn = "X";
let gameover = false;
...
function flip(a) {
    ...
    for (var i = a + 1; i < a - a % 8 + 8; i++) {
        if (boxer[i].innerHTML === turn) {
            for (var j = a + 1; j < i; j++) {
                if (turn === "X") { boxer[j].innerHTML = "X" }
    ...
    arrayitem.addEventListener('click', () => {
        if (!gameover) {
            if (boxtext.innerHTML === '') {
                ...
                if (!gameover) {
                    if (turn === "X") { document.getElementsByClassName("changename")[0].innerHTML = "Turn for X"; }
        ...
        if (gameover) {
            ...
            if (z > 32) { document.getElementsByClassName("changename")[0].innerHTML = "X Wins"; }
            if (z < 32) { document.getElementsByClassName("changename")[0].innerHTML = "O Wins"; }
